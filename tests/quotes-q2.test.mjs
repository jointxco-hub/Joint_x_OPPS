...
//       / revoke_quote_share). Quote->Order/Quote->Invoice Phase 1:
//       convert_quote_to_order + convert_quote_to_invoice.
...
test("quotes.js writes ONLY through canonical RPCs — never a direct table write", async () => {
  ...
  assert.deepEqual(rpcCalls, [
    'supabase.rpc("convert_quote_to_invoice"',
  ...
  ], "the ONLY rpcs this module calls are the Q1/Q2.5 save+send, the Q3.1 canonical share RPCs, and Phase 1's convert_quote_to_order + convert_quote_to_invoice");
});
