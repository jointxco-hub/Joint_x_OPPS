  ...
  Client: {
    ...
    normalize(row) {
      return {
        ...
        saved_contact_name: row.saved_contact_name,
        delivery_address: row.delivery_address,
        pep_code: row.pep_code,
    ...
    serialize(payload) {
      return compactObject({
        ...
        saved_contact_name: payload.saved_contact_name,
        delivery_address: payload.delivery_address,
        pep_code: payload.pep_code,
        delivery_note: payload.delivery_note,
        preferred_courier: payload.preferred_courier,
        company_name: payload.company_name,
        status: payload.status,
        total_orders: numberOrUndefined(payload.total_orders),
        total_revenue: numberOrUndefined(payload.total_revenue),
        last_activity_date: dateOrUndefined(payload.last_activity_date),
        portal_enabled: payload.portal_enabled,
        xlab_auth_user_id: idOrUndefined(payload.xlab_auth_user_id),
        xlab_customer_id: payload.xlab_customer_id,
        notes: payload.notes,
  ...
  ClientProduct: {
    ...
    serialize(payload) {
      return compactObject({
        ...
        created_from_order_id: payload.created_from_order_id,
        ...
        requires_quote: payload.requires_quote,
        print_method: payload.print_method,
        placement: payload.placement,
        print_size: payload.print_size,
        print_locations: numberOrUndefined(payload.print_locations),
        garment_material: payload.garment_material,
        garment_gsm: payload.garment_gsm,
  ...
  Supplier: {
    ...
    serialize(payload) {
      return compactObject({
        ...
        lead_time_days: numberOrUndefined(payload.lead_time_days),
  ...
  CatalogItem: {
    ...
    normalize(row) {
      ...
      return {
        ...
        print_options: Array.isArray(row.print_options) ? row.print_options : [],
        store_visible: row.store_visible !== false,
        price,
        base_price: price,
        created_date: row.created_at,
        updated_date: row.updated_at,
