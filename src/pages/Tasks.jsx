...
import { 
  ...
  Palette, Scissors, Printer, Package, Truck
} from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-6xl mx-auto p-4 md:p-8">
        ...
        {Object.keys(tasksByPhase).length > 0 && (
          <Card className="p-4 mb-6 bg-gradient-to-r from-slate-800 to-slate-900 text-white border-0">
            <h3 className="font-semibold mb-3 flex items-center gap-2">
              <Filter className="w-4 h-4" /> Production Phases
            </h3>
