...
export default function TypeformPOForm({ 
  ...
  const [formData, setFormData] = useState(purchaseOrder || {
    ...
    supplier_name: "",
    status: "draft",
    items: [{ name: "", quantity: 1, unit: "pieces", unit_price: 0, total: 0 }],
    subtotal: 0,
    tax: 0,
    total: 0,
    notes: "",
  ...
  const addItem = () => {
    setFormData(prev => ({
      ...prev,
      items: [...prev.items, { name: "", quantity: 1, unit: "pieces", unit_price: 0, total: 0 }]
    }));
  };
  ...
  const steps = [
    <TypeformInput
      ...
      subtitle="Select the supplier for this purchase order"
